		...
		<>
			...
			<main className='flex flex-col px-6 gap-20 py-20 items-center'>
				...
				<section className='flex flex-col items-center gap-20 max-w-5xl'>
					...
					<Text size='xl'>
						Permite a descoberta de todas as pinturas murais realizadas até ao momento,
						bem como de informações sobre as mesmas. Leva-nos também a lugares que
						destacamos na nossa aldeia como “pontos de interesse”, como eiras para
